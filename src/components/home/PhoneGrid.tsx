        ...
        >
          ...
          >
            <Image
              ...
              className="object-contain p-4 transall group-hover:scale-105"
            />
          </div>
          ...
          <div className="flex flex-col gap-2 p-3">
            <div>
              <p className="text-[10px] font-medium uppercase tracking-widest" style={{ color: "var(--gold)" }}>
                {phone.brand}
              </p>
              <p className="text-sm font-semibold leading-snug mt-0.5 line-clamp-2" style={{ color: "var(--text)" }}>
                {phone.name}
              </p>
            </div>
            ...
            >
              {[
                ...
                { icon: <Cpu size={10} />, val: phone.ramChipset.split("/")[0].trim() },
