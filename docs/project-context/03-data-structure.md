# 03 — Struktur Data & Types (Updated)

> Diupdate berdasarkan hasil scraping GSMArena — kategori spesifikasi sudah sesuai struktur real.

## Type Definitions (`src/types/phone.ts`)
...
export type PhoneSpecs = {
  ...
  resolution: string            // e.g. "1080 x 2340 pixels, 19.5:9"
  ...
  // MEMORY
  cardSlot: string              // e.g. "No" atau "microSDXC"
...
[
  {
    ...
    "displayInches": "6.2\"",
    "mainCameraMP": "50MP",
    "ramChipset": "8GB / Exynos 2400",
    "batteryMah": "4000mAh",
    "specs": {
      "network": "GSM / HSPA / LTE / 5G",
      "announced": "2024, January 17",
      "status": "Available. Released 2024, January 31",
      ...
      "mainCameraVideo": "8K@30fps, 4K@60fps",
...
## Catatan
- `displayInches`, `mainCameraMP`, `ramChipset`, `batteryMah` → shortcut untuk hero section & card — tidak perlu parse dari `specs`
- Urutan kategori `specs` mengikuti persis tabel di halaman detail GSMArena
- Mock data ~10 HP harus mencakup minimal 4–5 brand: Samsung, Apple, Xiaomi, iPhone, Oppo
